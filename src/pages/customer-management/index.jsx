        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200 p-6 shadow-lg mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-white bg-green-500 px-3 py-1 rounded-full">Buscar por teléfono</label>
                <div className="bg-green-100 rounded-2xl p-3 shadow-lg hover:shadow-xl hover:bg-green-200 transition-all duration-200">
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      className="pl-10 bg-green-50 border-0 text-green-800 placeholder-green-500 focus:ring-0 focus:outline-none shadow-none rounded-xl"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-white bg-purple-500 px-3 py-1 rounded-full">Buscar por fecha</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-white bg-pink-500 px-3 py-1 rounded-full">Filtrar por usuario</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-white bg-yellow-500 px-3 py-1 rounded-full">Filtrar por empresa</label>
